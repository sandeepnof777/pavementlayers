        ...
        <tr>
            <td valign="top" width="220">
                ...
                if (isset($clientSignature) && ($clientSignature)) {
                    echo '<br>';
                    ?>
                    <span id="signed_span">Signed : 
                    <?php echo  date('m/d/Y g:i A', strtotime($clientSignature->getCreatedAt()) + TIMEZONE_OFFSET); ?>
                    </span>
                <?php
                }
                ?><br>
...
<?php if (isset($checkProposalChecklist) && (isset($proposalChecklistData)) && ($checkProposalChecklist==1)) { ?>
         ...
         <div class="row">
            <div style="page-break-inside: avoid">
                <div class="customer-checklist-container">
                    ...
                    <div class="customer-checklist-data billing_phone">
                        <?php  
                    ...
                    <p></p>
                    <span class="customer-checklist-span-label"><strong>Phone:</strong></span>
                    <div class="customer-checklist-data customer_phone">
                        <?php  
                    ...
                    <div class="customer-checklist-data invoicing_portal">
                        <?php  
